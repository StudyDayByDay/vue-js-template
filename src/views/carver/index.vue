<template>
  <div class="carver">
    ...
    <div class="header">
      ...
      <el-button :color="color" :dark="true" @click="addExDataLabel"
        >使用exData字段添加位置相同的标签</el-button
      >
      <el-button :color="color" :dark="true" @click="signLabel">单个划词并添加标签</el-button>
      <el-button :color="color" :dark="true" @click="multipleWordLabel"
        >多个划词并添加标签</el-button
      >
      <el-button :color="color" :dark="true" @click="scrollToLabel">滚动到标签位置</el-button>
      <el-button :color="color" :dark="true" @click="highLightScroll"
        >高亮并滚动到标签位置</el-button
      >
      ...
      <div class="content-right">
        <el-tabs v-model="activeName">
          <el-tab-pane label="实体" name="entity">
            <el-collapse>
              <el-collapse-item name="relation" title="肺炎"> xxx </el-collapse-item>
            </el-collapse>
          </el-tab-pane>
...
<script setup>
  ...
  const addLargePath = () => {
    ...
    // });
    // 4.53
    carver.addPathByExData(paths);
  };

  // 复杂页面删除关系
  const deletePath = () => {
    carver.removePathByExData(444);
  };
  ...
  // 复杂页面删除实体
  const deleteEntity = () => {
    carver.removeLabelByExData(343);
  };
